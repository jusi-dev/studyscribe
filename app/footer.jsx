    ...
    return (
        <footer className="bg-gray-900 text-gray-300">
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:flex md:gap-20 gap-8">
                    {/* Company Info */}
                    <div className="space-y-4">
                        <h3 className="text-white font-bold text-lg">StudAI</h3>
                        <p className="text-sm">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://x.com/studaidotio" target='_blank' className="hover:text-white transition-colors">
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center">
                    <p>&copy; {new Date().getFullYear()} StudAI. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
